...
const handleAdd = async (fields: API.ItemData) => {
  ...
  try {
    await addItem('/categories', { ...fields });
    hide();
...
const handleUpdate = async (fields: FormValueType) => {
  ...
  try {
    await updateItem(`/categories/${fields._id}`, fields);
    hide();
...
const handleRecharge = async (fields: FormValueType) => {
  ...
  try {
    await addItem(`/categories/${fields._id}/recharge`, fields);
    hide();
  ...
  return (
    <PageContainer>
      <ProTable<API.ItemData, API.PageParams>
        ...
        request={async (params, sort, filter) => queryList('/categories', params, sort, filter)}
        columns={columns}
        rowSelection={{
